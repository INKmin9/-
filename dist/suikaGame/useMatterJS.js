...
var createFixedItem = function (_a) {
  ...
  var radius =
    (feature === null || feature === void 0 ? void 0 : feature.radius) || 1;
  var mass =
    (feature === null || feature === void 0 ? void 0 : feature.mass) || 1;
  ...
  var newNextItem =
    (_b = getRandomFruitFeature()) === null || _b === void 0
      ? void 0
      : _b.label;
...
var setPositionFixedItem = function (event) {
  ...
  var maxX = fixedItem.circleRadius
...
var event = function (props, effects) {
  ...
  Matter.Events.on(mouseConstraint, "enddrag", function (event) {
    ...
    popSound.play();
    var label =
      fixedItem === null || fixedItem === void 0 ? void 0 : fixedItem.label;
    var feature = getFruitFeature(label);
    var radius =
      (feature === null || feature === void 0 ? void 0 : feature.radius) || 1;
    var mass =
      (feature === null || feature === void 0 ? void 0 : feature.mass) || 1;
    var newItem = Matter.Bodies.circle(
  ...
  Matter.Events.on(engine, "collisionStart", function (event) {
    ...
    pairs.forEach(function (pair) {
      ...
      if (labelA === labelB) {
        ...
        var radius =
          (feature === null || feature === void 0 ? void 0 : feature.radius) ||
          1;
        var mass =
          (feature === null || feature === void 0 ? void 0 : feature.mass) || 1;
        var score_1 =
          (feature === null || feature === void 0 ? void 0 : feature.score) ||
          0;
        // 수박이 만들어지면 폭죽 이펙트
...
var useMatterJS = function (props) {
  var _a = useConfetti(),
    fireConfetti = _a.fireConfetti,
    fireRapidStarConfetti = _a.fireRapidStarConfetti;
  useEffect(function () {
    init(props);
    event(props, {
