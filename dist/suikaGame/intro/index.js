...
var Intro = function (_a) {
  var isVisible = _a.isVisible,
    handleGameStart = _a.handleGameStart;
  ...
  var fruitItemEls = Object.keys(Fruit)
  ...
  return _jsxs(
    "div",
    __assign(
      { className: cx("introArea") },
      {
        children: [
          _jsx(
            "ul",
            __assign({ className: cx("listWrap") }, { children: fruitItemEls })
          ),
          _jsx(
            "div",
            __assign(
              { className: cx("titleArea") },
              {
                children: _jsx(
                  "button",
                  __assign(
                    { className: cx("btn"), onClick: onClick },
                    { children: "GAME START" }
                  )
                ),
              }
          ...
          _jsx(
            "span",
            __assign({ className: cx("version") }, { children: "v1.0.4" })
          ),
        ],
      }
    )
